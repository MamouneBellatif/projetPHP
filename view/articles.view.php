...
echo '<section>';
  if ($okPrec){
    ...
    echo "<a href=\"../controler/main.ctrl.php?pred=1&cat=$cat&ref=$refFirst\"><img src=\"design/left-arrow.png\" alt=\"Précédents\"></a>";
  }
  if ($okNext){
    $refEnd = end($articles)->ref;
    echo "<a href=\"../controler/main.ctrl.php?next=1&cat=$cat&ref=$refEnd\"><img src=\"design/right-arrow.png\" alt=\"Suivants\"></a>";
  }
echo '</section>';
